...
const lightQuestTheme = createTheme({
    components: {
        ...
        MuiAlert: {
            defaultProps: {
                iconMapping: {
                    error: React.createElement(SvgIcon, { component: ErrorOutline }),
                    warning: React.createElement(SvgIcon, { component: WarningAmberOutlined }),
                    info: React.createElement(SvgIcon, { component: InfoOutlined }),
                    success: React.createElement(SvgIcon, { component: CheckCircleOutlined }),
                },
            },
            styleOverrides: {
                filledError: {
        ...
        MuiAvatar: {
            styleOverrides: {
                ...
                colorDefault: {
                    ...
                    fontStyle: lightGlobalTheme.typography['Components']['Avatar Initials']
                        .fontStyle,
                    fontFamily: lightGlobalTheme.typography['Components']['Avatar Initials']
                        .fontFamily,
                    fontWeight: lightGlobalTheme.typography['Components']['Avatar Initials']
                        .fontWeight,
                    fontSize: lightGlobalTheme.typography['Components']['Avatar Initials']
                        .fontSize,
                    letterSpacing: lightGlobalTheme.typography['Components']['Avatar Initials']
                        .letterSpacing,
                    lineHeight: lightGlobalTheme.typography['Components']['Avatar Initials']
                        .lineHeight,
                    textDecoration: lightGlobalTheme.typography['Components']['Avatar Initials']
                        .textDecoration,
                    textTransform: lightGlobalTheme.typography['Components']['Avatar Initials']
                        .textTransform,
                },
            },
        },
        MuiButton: {
            styleOverrides: {
                ...
                containedSizeMedium: {
                    fontStyle: lightGlobalTheme.typography['Components']['Button Medium']
                        .fontStyle,
                    fontFamily: lightGlobalTheme.typography['Components']['Button Medium']
                        .fontFamily,
                    fontWeight: lightGlobalTheme.typography['Components']['Button Medium']
                        .fontWeight,
                    fontSize: lightGlobalTheme.typography['Components']['Button Medium']
                        .fontSize,
                    letterSpacing: lightGlobalTheme.typography['Components']['Button Medium']
                        .letterSpacing,
                    lineHeight: lightGlobalTheme.typography['Components']['Button Medium']
                        .lineHeight,
                    textDecoration: lightGlobalTheme.typography['Components']['Button Medium']
                        .textDecoration,
                    textTransform: lightGlobalTheme.typography['Components']['Button Medium']
                        .textTransform,
                    padding: `6px 16px`,
                    borderRadius: `4px`,
                    height: `36px`,
                ...
                containedSizeSmall: {
                    fontStyle: lightGlobalTheme.typography['Components']['Button Small']
                        .fontStyle,
                    fontFamily: lightGlobalTheme.typography['Components']['Button Small']
                        .fontFamily,
                    fontWeight: lightGlobalTheme.typography['Components']['Button Small']
                        .fontWeight,
                    fontSize: lightGlobalTheme.typography['Components']['Button Small']
                        .fontSize,
                    letterSpacing: lightGlobalTheme.typography['Components']['Button Small']
                        .letterSpacing,
                    lineHeight: lightGlobalTheme.typography['Components']['Button Small']
                        .lineHeight,
                    textDecoration: lightGlobalTheme.typography['Components']['Button Small']
                        .textDecoration,
                    textTransform: lightGlobalTheme.typography['Components']['Button Small']
                        .textTransform,
                    padding: `4px 10px`,
                    borderRadius: `4px`,
                    height: `30px`,
                ...
                containedPrimary: {
                    ...
                    boxShadow: lightGlobalTheme.customShadows['Elevation']['2'].boxShadow,
                    color: `rgba(255, 255, 255, 1)`,
                    '&:hover': {
                        backgroundColor: lightGlobalTheme.palette['Primary']['Dark'],
                        boxShadow: lightGlobalTheme.customShadows['Elevation']['4'].boxShadow,
                        color: `rgba(255, 255, 255, 1)`,
                    },
                    '&:disabled': {
                        backgroundColor: lightGlobalTheme.palette['Action']['Disabled Background (12p)'],
                    },
                },
                containedSecondary: {
                ...
                textSizeLarge: {
                    fontStyle: lightGlobalTheme.typography['Components']['Button Large']
                        .fontStyle,
                    fontFamily: lightGlobalTheme.typography['Components']['Button Large']
                        .fontFamily,
                    fontWeight: lightGlobalTheme.typography['Components']['Button Large']
                        .fontWeight,
                    fontSize: lightGlobalTheme.typography['Components']['Button Large']
                        .fontSize,
                    letterSpacing: lightGlobalTheme.typography['Components']['Button Large']
                        .letterSpacing,
                    lineHeight: lightGlobalTheme.typography['Components']['Button Large']
                        .lineHeight,
                    textDecoration: lightGlobalTheme.typography['Components']['Button Large']
                        .textDecoration,
                    textTransform: lightGlobalTheme.typography['Components']['Button Large']
                        .textTransform,
                    padding: `8px 11px`,
                    borderRadius: `4px`,
                    height: `42px`,
                ...
                textPrimary: {
                    ...
                    '&:hover': {
                        backgroundColor: lightGlobalTheme.palette['Primary']['Shades']['4p'],
                        color: `rgba(25, 118, 210, 1)`,
                    },
                    '&:disabled': {
                ...
                textSecondary: {
                    ...
                    '&:hover': {
                        backgroundColor: lightGlobalTheme.palette['Secondary']['Shades']['4p'],
                        color: `rgba(156, 39, 176, 1)`,
                    },
                    '&:disabled': {
                        color: `rgba(0, 0, 0, 0.26)`,
                ...
                textError: {
                    ...
                    '&:hover': {
                        backgroundColor: lightGlobalTheme.palette['Error']['Shades']['4p'],
                        color: `rgba(211, 47, 47, 1)`,
                    },
                    '&:disabled': {
                        color: `rgba(0, 0, 0, 0.26)`,
                ...
                textSuccess: {
                    ...
                    '&:hover': {
                        backgroundColor: lightGlobalTheme.palette['Success']['Shades']['4p'],
                        color: `rgba(46, 125, 50, 1)`,
                    },
                    '&:disabled': {
                        color: `rgba(0, 0, 0, 0.26)`,
                ...
                textWarning: {
                    ...
                    '&:hover': {
                        backgroundColor: lightGlobalTheme.palette['Warning']['Shades']['4p'],
                        color: `rgba(237, 108, 2, 1)`,
                    },
                    '&:disabled': {
                        color: `rgba(0, 0, 0, 0.26)`,
        ...
        MuiCheckbox: {
            defaultProps: {
                icon: React.createElement(SvgIcon, { component: CheckBoxOutlineBlank }),
                indeterminateIcon: React.createElement(SvgIcon, { component: IndeterminateCheckBo }),
                checkedIcon: React.createElement(SvgIcon, { component: CheckBoxFilled }),
            },
            styleOverrides: {
                root: {
                    '&:hover': {
        ...
        MuiFormControlLabel: {
            styleOverrides: {
                label: {
                    ...
                    fontStyle: lightGlobalTheme.typography['Typography']['Body 1'].fontStyle,
                    fontFamily: lightGlobalTheme.typography['Typography']['Body 1'].fontFamily,
                    fontWeight: lightGlobalTheme.typography['Typography']['Body 1'].fontWeight,
                    fontSize: lightGlobalTheme.typography['Typography']['Body 1'].fontSize,
                    letterSpacing: lightGlobalTheme.typography['Typography']['Body 1'].letterSpacing,
                    lineHeight: lightGlobalTheme.typography['Typography']['Body 1'].lineHeight,
                    textDecoration: lightGlobalTheme.typography['Typography']['Body 1']
                        .textDecoration,
                    textTransform: lightGlobalTheme.typography['Typography']['Body 1'].textTransform,
                    '&.Mui-disabled': {
                        ...
                        fontWeight: lightGlobalTheme.typography['Typography']['Body 1'].fontWeight,
                        fontSize: lightGlobalTheme.typography['Typography']['Body 1'].fontSize,
                        letterSpacing: lightGlobalTheme.typography['Typography']['Body 1']
                            .letterSpacing,
                        lineHeight: lightGlobalTheme.typography['Typography']['Body 1'].lineHeight,
                        textDecoration: lightGlobalTheme.typography['Typography']['Body 1']
                            .textDecoration,
                        textTransform: lightGlobalTheme.typography['Typography']['Body 1']
                            .textTransform,
                    },
                },
                root: {
        ...
        MuiDialog: {
            styleOverrides: {
                root: {
                    borderRadius: `4px`,
                    boxShadow: lightGlobalTheme.customShadows['Elevation']['24'].boxShadow,
                    padding: `8px 24px`,
                },
                paper: {
        ...
        MuiFilledInput: {
            styleOverrides: {
                root: {
                    color: lightGlobalTheme.palette['Text']['Primary'],
                    fontStyle: lightGlobalTheme.typography['Components']['Input Text'].fontStyle,
                    fontFamily: lightGlobalTheme.typography['Components']['Input Text']
                        .fontFamily,
                    fontWeight: lightGlobalTheme.typography['Components']['Input Text']
                        .fontWeight,
                    fontSize: lightGlobalTheme.typography['Components']['Input Text'].fontSize,
                    letterSpacing: lightGlobalTheme.typography['Components']['Input Text']
                        .letterSpacing,
                    lineHeight: lightGlobalTheme.typography['Components']['Input Text']
                        .lineHeight,
                    textDecoration: lightGlobalTheme.typography['Components']['Input Text']
                        .textDecoration,
                    textTransform: lightGlobalTheme.typography['Components']['Input Text']
                        .textTransform,
                },
                sizeSmall: {
                    color: lightGlobalTheme.palette['Text']['Primary'],
        ...
        MuiTooltip: {
            styleOverrides: {
                tooltip: {
                    ...
                    fontStyle: lightGlobalTheme.typography['Components']['Tooltip'].fontStyle,
                    fontFamily: lightGlobalTheme.typography['Components']['Tooltip'].fontFamily,
                    fontWeight: lightGlobalTheme.typography['Components']['Tooltip'].fontWeight,
                    fontSize: lightGlobalTheme.typography['Components']['Tooltip'].fontSize,
                    letterSpacing: lightGlobalTheme.typography['Components']['Tooltip']
                        .letterSpacing,
                    lineHeight: lightGlobalTheme.typography['Components']['Tooltip'].lineHeight,
                    textDecoration: lightGlobalTheme.typography['Components']['Tooltip']
                        .textDecoration,
                    textTransform: lightGlobalTheme.typography['Components']['Tooltip']
                        .textTransform,
                },
                arrow: {
...
//# sourceMappingURL=CaratDesignSystemLightTheme.js.map