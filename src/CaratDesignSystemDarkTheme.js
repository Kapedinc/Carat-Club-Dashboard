...
const darkQuestTheme = createTheme({
    components: {
        ...
        MuiAvatar: {
            styleOverrides: {
                ...
                colorDefault: {
                    ...
                    fontStyle: darkGlobalTheme.typography['Components']['Avatar Initials']
                        .fontStyle,
                    fontFamily: darkGlobalTheme.typography['Components']['Avatar Initials']
                        .fontFamily,
                    fontWeight: darkGlobalTheme.typography['Components']['Avatar Initials']
                        .fontWeight,
                    fontSize: darkGlobalTheme.typography['Components']['Avatar Initials']
                        .fontSize,
                    letterSpacing: darkGlobalTheme.typography['Components']['Avatar Initials']
                        .letterSpacing,
                    lineHeight: darkGlobalTheme.typography['Components']['Avatar Initials']
                        .lineHeight,
                    textDecoration: darkGlobalTheme.typography['Components']['Avatar Initials']
                        .textDecoration,
                    textTransform: darkGlobalTheme.typography['Components']['Avatar Initials']
                        .textTransform,
                },
            },
        },
        MuiButton: {
            styleOverrides: {
                containedSizeLarge: {
                    fontStyle: darkGlobalTheme.typography['Components']['Button Large']
                        .fontStyle,
                    fontFamily: darkGlobalTheme.typography['Components']['Button Large']
                        .fontFamily,
                    fontWeight: darkGlobalTheme.typography['Components']['Button Large']
                        .fontWeight,
                    fontSize: darkGlobalTheme.typography['Components']['Button Large'].fontSize,
                    letterSpacing: darkGlobalTheme.typography['Components']['Button Large']
                        .letterSpacing,
                    lineHeight: darkGlobalTheme.typography['Components']['Button Large']
                        .lineHeight,
                    textDecoration: darkGlobalTheme.typography['Components']['Button Large']
                        .textDecoration,
                    textTransform: darkGlobalTheme.typography['Components']['Button Large']
                        .textTransform,
                    padding: `8px 22px`,
                    borderRadius: `4px`,
                    height: `42px`,
                ...
                containedSizeMedium: {
                    fontStyle: darkGlobalTheme.typography['Components']['Button Medium']
                        .fontStyle,
                    fontFamily: darkGlobalTheme.typography['Components']['Button Medium']
                        .fontFamily,
                    fontWeight: darkGlobalTheme.typography['Components']['Button Medium']
                        .fontWeight,
                    fontSize: darkGlobalTheme.typography['Components']['Button Medium']
                        .fontSize,
                    letterSpacing: darkGlobalTheme.typography['Components']['Button Medium']
                        .letterSpacing,
                    lineHeight: darkGlobalTheme.typography['Components']['Button Medium']
                        .lineHeight,
                    textDecoration: darkGlobalTheme.typography['Components']['Button Medium']
                        .textDecoration,
                    textTransform: darkGlobalTheme.typography['Components']['Button Medium']
                        .textTransform,
                    padding: `6px 16px`,
                    borderRadius: `4px`,
                    height: `36px`,
                ...
                containedSizeSmall: {
                    fontStyle: darkGlobalTheme.typography['Components']['Button Small']
                        .fontStyle,
                    fontFamily: darkGlobalTheme.typography['Components']['Button Small']
                        .fontFamily,
                    fontWeight: darkGlobalTheme.typography['Components']['Button Small']
                        .fontWeight,
                    fontSize: darkGlobalTheme.typography['Components']['Button Small'].fontSize,
                    letterSpacing: darkGlobalTheme.typography['Components']['Button Small']
                        .letterSpacing,
                    lineHeight: darkGlobalTheme.typography['Components']['Button Small']
                        .lineHeight,
                    textDecoration: darkGlobalTheme.typography['Components']['Button Small']
                        .textDecoration,
                    textTransform: darkGlobalTheme.typography['Components']['Button Small']
                        .textTransform,
                    padding: `4px 10px`,
                    borderRadius: `4px`,
                    height: `30px`,
                ...
                containedPrimary: {
                    ...
                    boxShadow: darkGlobalTheme.customShadows['Elevation']['2'].boxShadow,
                    color: `rgba(0, 0, 0, 0.87)`,
                    '&:hover': {
                        backgroundColor: darkGlobalTheme.palette['Primary']['Dark'],
                        boxShadow: darkGlobalTheme.customShadows['Elevation']['4'].boxShadow,
                        color: `rgba(0, 0, 0, 0.87)`,
                    },
                    '&:disabled': {
                        backgroundColor: darkGlobalTheme.palette['Action']['Disabled Background (12p)'],
                    },
                },
                containedSecondary: {
                ...
                textPrimary: {
                    ...
                    '&:hover': {
                        backgroundColor: darkGlobalTheme.palette['Primary']['Shades']['8p'],
                        color: `rgba(144, 202, 249, 1)`,
                    },
                    '&:disabled': {
                ...
                textSecondary: {
                    ...
                    '&:hover': {
                        backgroundColor: darkGlobalTheme.palette['Secondary']['Shades']['8p'],
                        color: `rgba(206, 147, 216, 1)`,
                    },
                    '&:disabled': {
                        color: `rgba(255, 255, 255, 0.3)`,
        ...
        MuiFormControlLabel: {
            styleOverrides: {
                label: {
                    ...
                    fontStyle: darkGlobalTheme.typography['Typography']['Body 1'].fontStyle,
                    fontFamily: darkGlobalTheme.typography['Typography']['Body 1'].fontFamily,
                    fontWeight: darkGlobalTheme.typography['Typography']['Body 1'].fontWeight,
                    fontSize: darkGlobalTheme.typography['Typography']['Body 1'].fontSize,
                    letterSpacing: darkGlobalTheme.typography['Typography']['Body 1'].letterSpacing,
                    lineHeight: darkGlobalTheme.typography['Typography']['Body 1'].lineHeight,
                    textDecoration: darkGlobalTheme.typography['Typography']['Body 1'].textDecoration,
                    textTransform: darkGlobalTheme.typography['Typography']['Body 1'].textTransform,
                    '&.Mui-disabled': {
                        color: `rgba(255, 255, 255, 0.3)`,
                        fontStyle: darkGlobalTheme.typography['Typography']['Body 1'].fontStyle,
                        fontFamily: darkGlobalTheme.typography['Typography']['Body 1'].fontFamily,
                        fontWeight: darkGlobalTheme.typography['Typography']['Body 1'].fontWeight,
                        fontSize: darkGlobalTheme.typography['Typography']['Body 1'].fontSize,
                        letterSpacing: darkGlobalTheme.typography['Typography']['Body 1']
                            .letterSpacing,
                        lineHeight: darkGlobalTheme.typography['Typography']['Body 1'].lineHeight,
                        textDecoration: darkGlobalTheme.typography['Typography']['Body 1']
                            .textDecoration,
                        textTransform: darkGlobalTheme.typography['Typography']['Body 1']
                            .textTransform,
                    },
                },
                root: {
        ...
        MuiDialog: {
            styleOverrides: {
                root: {
                    borderRadius: `4px`,
                    boxShadow: darkGlobalTheme.customShadows['Elevation']['24'].boxShadow,
                    padding: `8px 24px`,
                },
                paper: {
        ...
        MuiFilledInput: {
            styleOverrides: {
                root: {
                    color: darkGlobalTheme.palette['Text']['Primary'],
                    fontStyle: darkGlobalTheme.typography['Components']['Input Text'].fontStyle,
                    fontFamily: darkGlobalTheme.typography['Components']['Input Text'].fontFamily,
                    fontWeight: darkGlobalTheme.typography['Components']['Input Text'].fontWeight,
                    fontSize: darkGlobalTheme.typography['Components']['Input Text'].fontSize,
                    letterSpacing: darkGlobalTheme.typography['Components']['Input Text']
                        .letterSpacing,
                    lineHeight: darkGlobalTheme.typography['Components']['Input Text'].lineHeight,
                    textDecoration: darkGlobalTheme.typography['Components']['Input Text']
                        .textDecoration,
                    textTransform: darkGlobalTheme.typography['Components']['Input Text']
                        .textTransform,
                },
                sizeSmall: {
                    color: darkGlobalTheme.palette['Text']['Primary'],
        ...
        MuiTooltip: {
            styleOverrides: {
                tooltip: {
                    ...
                    fontStyle: darkGlobalTheme.typography['Components']['Tooltip'].fontStyle,
                    fontFamily: darkGlobalTheme.typography['Components']['Tooltip'].fontFamily,
                    fontWeight: darkGlobalTheme.typography['Components']['Tooltip'].fontWeight,
                    fontSize: darkGlobalTheme.typography['Components']['Tooltip'].fontSize,
                    letterSpacing: darkGlobalTheme.typography['Components']['Tooltip'].letterSpacing,
                    lineHeight: darkGlobalTheme.typography['Components']['Tooltip'].lineHeight,
                    textDecoration: darkGlobalTheme.typography['Components']['Tooltip']
                        .textDecoration,
                    textTransform: darkGlobalTheme.typography['Components']['Tooltip'].textTransform,
                },
                arrow: {
...
//# sourceMappingURL=CaratDesignSystemDarkTheme.js.map