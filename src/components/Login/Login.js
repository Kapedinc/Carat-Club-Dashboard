...
function Login(props) {
    return (React.createElement(Login1, { className: props.className },
        React.createElement(Login2, null, `Login`),
        React.createElement(Frame68, null,
            React.createElement(Input2, null),
            React.createElement(Input3, null),
            React.createElement(ForgotPassword, null, `Forgot password?`),
