...
function WeekendSpecials(props: WeekendSpecialsProps): JSX.Element {
  return (
    <WeekendSpecials1 className={props.className}>
      <Rectangle24 src={Rectangle24Image} loading="lazy" alt={'Rectangle 24'} />
      <Rectangle4807
        src={Rectangle4807Image}
        loading="lazy"
        alt={'Rectangle 4807'}
      />
      <MarriottFlorida>{`Marriott Florida`}</MarriottFlorida>
      <HereSADescriptionFor>
        {`Here’s a description for the deal that can go up to two lines.`}
      </HereSADescriptionFor>
      <Button1>
        <Q250150>
          <Q250150Span1>{`$250`}</Q250150Span1>
          <Q250150Span2>{`  `}</Q250150Span2>
          <Q250150Span3>{`$150`}</Q250150Span3>
        </Q250150>
      </Button1>
    </WeekendSpecials1>
  );
